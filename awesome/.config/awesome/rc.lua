...
tags = {
 --names  = { "main", "ref", "work", "chat", "www", "misc" },
 names = { 1, 2, 3, 4, 5, 6, 7, 8, 9 },
 --layout = { layouts[1], layouts[5], layouts[1], layouts[1], layouts[5], layouts[1] }
}
for s = 1, screen.count() do
    -- Each screen has its own tag table.
   tags[s] = awful.tag(tags.names, s, layouts[1]) --tags.layout)
end
-- }}}
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "u",      function (c) awful.client.movetoscreen(c)   end),
    awful.key({ modkey, "Shift"   }, "i",      function (c) awful.client.movetoscreen(c)   end),
